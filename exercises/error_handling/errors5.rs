...
// If we want to box up and propogate any errors, we can use Box<dyn error::Error>> and this would work on all types
// which have implemented the error::Error trait (impl error::Error for Struct/Enum)
